                                        ...
                                        value: function parseGroup(optional) {
                                            ...
                                            if (this.nextToken.text === (optional ? '[' : '{')) {
                                                ...
                                                return new ParseFuncOrArgument(
                                                    new _ParseNode2.default('ordgroup', expression, this.mode, firstToken, lastToken),
                                                    false
                                                );
                                            } else {
                                    ...
                                    },
                                    {
                                        ...
                                        value: function parseSymbol() {
                                            ...
                                            if (_functions2.default[nucleus.text]) {
                                                ...
                                                this.consume();
                                                return new ParseFuncOrArgument(
                                                    new _ParseNode2.default('textord', nucleus.text, this.mode, nucleus),
                                                    false,
                                                    nucleus
                                                );
                        ...
                        function (require, module, exports) {
                            ...
                            var makeSymbol = function makeSymbol(value, fontFamily, mode, options, classes) {
                                ...
                                if (metrics) {
                                    ...
                                    typeof console !== 'undefined' &&
                                        console.warn("No character metrics for '" + value + "' in style '" + fontFamily + "'");
                        ...
                        function (require, module, exports) {
                            ...
                            var buildExpression = function buildExpression(expression, options, isRealGroup) {
                                ...
                                for (var _i2 = 0; _i2 < groups.length; _i2++) {
                                    if (
                                        isBin(groups[_i2]) &&
                                        (isBinLeftCanceller(groups[_i2 - 1], isRealGroup) || isBinRightCanceller(groups[_i2 + 1], isRealGroup))
                                    ) {
                            ...
                            var shouldHandleSupSub = function shouldHandleSupSub(group, options) {
                                if (!group.value.base) {
                                    ...
                                    if (base.type === 'op') {
                                        ...
                                        return (
                                            base.value.limits &&
                                            (options.style.size === _Style2.default.DISPLAY.size || base.value.alwaysHandleSupSub)
                                        );
                            ...
                            groupTypes.supsub = function (group, options) {
                                ...
                                if (group.value.sup) {
                                    ...
                                    if (!isCharacterBox(group.value.base)) {
                                        supShift =
                                            base.height - (newOptions.fontMetrics().supDrop * newOptions.sizeMultiplier) / options.sizeMultiplier;
                                    }
                                }
                                ...
                                if (group.value.sub) {
                                    ...
                                    if (!isCharacterBox(group.value.base)) {
                                        subShift =
                                            base.depth + (newOptions.fontMetrics().subDrop * newOptions.sizeMultiplier) / options.sizeMultiplier;
                                    }
                                }
                            ...
                            groupTypes.spacing = function (group, options) {
                                if (group.value === '\\ ' || group.value === '\\space' || group.value === ' ' || group.value === '~') {
                                    ...
                                    if (group.mode === 'text') {
                                        ...
                                        return (0, _buildCommon.makeSpan)(
                                            ['mspace'],
                                            [_buildCommon2.default.mathsym(group.value, group.mode, options)],
                                            options
                                        );
                                    }
                                } else {
                                    ...
                                    // generate these.
                                    return (0, _buildCommon.makeSpan)(
                                        ['mspace', _buildCommon2.default.spacingFunctions[group.value].className],
                                        [],
                                        options
                                    );
                                }
                            ...
                            groupTypes.leftright = function (group, options) {
                                ...
                                if (group.value.left === '.') {
                                    ...
                                    // delimiter.
                                    leftDelim = _delimiter2.default.leftRightDelim(group.value.left, innerHeight, innerDepth, options, group.mode, [
                                        'mopen',
                                    ]);
                                }
                                ...
                                if (group.value.right === '.') {
                                    ...
                                    rightDelim = _delimiter2.default.leftRightDelim(group.value.right, innerHeight, innerDepth, options, group.mode, [
                                        'mclose',
                                    ]);
                                }
                    ...
                    38: [
                        function (require, module, exports) {
                            ...
                            var makeStackedDelim = function makeStackedDelim(delim, heightTotal, center, options, mode, classes) {
                                ...
                                return styleWrap(
                                    (0, _buildCommon.makeSpan)(['delimsizing', 'mult'], [inner], newOptions),
                                    _Style2.default.TEXT,
                                    options,
                                    classes
                                );
                            ...
                            var sqrtSpan = function sqrtSpan(height, delim, options) {
                                ...
                                if (delim.type === 'small') {
                                    ...
                                    span.innerHTML =
                                        "<svg width='100%' height='" + span.height + "em'>\n            " + sqrtInnerSVG['main'] + '</svg>';
