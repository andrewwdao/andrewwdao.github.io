...
(function()
{
  ...
  toEngPrec = function(val, sigFigs)      // rounds to X significant figures and no stripping of 0s
  {
    var unit = "pnum kMG",
        man = 0,
        pwr,
  ...
  AxisTicsAuto = function(mn, mx)   // optional 'numTics' forces the value of numSteps
  {
  ...
  */
  ...
  engNotation = function(val, tenthsOK)        // rounds to 2 dec places and strips trailing 0s
  {
    var unit = "pnum kMG",
    man = 0.0,
    pwr,
